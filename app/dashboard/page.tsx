...
if (orderError) {
  ...
  setError(
    "Siparişler alınamadı: " + orderError.message
  );
...
if (loading) {
return ( <main className="flex min-h-screen items-center justify-center"> <p className="text-gray-500">
Panel yükleniyor... </p> </main>
);
}

return ( <main className="min-h-screen bg-gray-50"> <header className="border-b bg-white"> <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5"> <a
         href="/"
    ...
    <div className="mt-8 rounded-3xl bg-white p-8 shadow-sm">
      <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Aktif ürünler mağazada yayınlanır. Pasif
            ürünler mağazadan kaldırılır ancak sipariş
            geçmişi korunur.
          </p>
        </div>
      </div>
